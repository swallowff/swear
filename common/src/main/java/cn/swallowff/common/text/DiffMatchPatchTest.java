 ...
 */
package cn.swallowff.common.text;

import cn.swallowff.common.text.DiffMatchPatch.Diff;
import cn.swallowff.common.text.DiffMatchPatch.LinesToCharsResult;
import cn.swallowff.common.text.DiffMatchPatch.Patch;
...
public class DiffMatchPatchTest {
  ...
  public void testDiffCharsToLines() {
    ...
    LinkedList<DiffMatchPatch.Diff> diffs = diffList(new DiffMatchPatch.Diff(EQUAL, "\u0001\u0002\u0001"), new Diff(INSERT, "\u0002\u0001\u0002"));
    ArrayList<String> tmpVector = new ArrayList<String>();
    tmpVector.add("");
    tmpVector.add("alpha\n");
    tmpVector.add("beta\n");
