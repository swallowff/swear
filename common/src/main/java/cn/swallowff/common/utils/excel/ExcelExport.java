...
import cn.swallowff.common.utils.excel.annotation.ExcelField;
import cn.swallowff.common.utils.excel.annotation.ExcelField.Align;
import cn.swallowff.common.utils.excel.annotation.ExcelField.Type;
import cn.swallowff.common.utils.excel.annotation.ExcelFields;
			...
			for (Object[] os : annotationList){
				...
				try{
					...
					if (StringUtils.isNotBlank(ef.dictType())){
						...
						val = dictUtils.getMethod("getLabel", String.class, Integer.class).invoke(null, ef.dictType(), val==null?"":val.toString(), "");
