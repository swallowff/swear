package cn.swallowff.admin.components.beetl.tag;
...
//    private DictService dictService;
    ...
    public void render() {
        ...
        //根据code查询字典数据
//        List<Dict> list = dictService.getDictByCode(code);
        List<DictCache> list = DictUtils.getDictByCode(code);  //从字典缓存里读取字典数据
