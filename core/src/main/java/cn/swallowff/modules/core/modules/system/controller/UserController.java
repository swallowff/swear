...
import cn.swallowff.modules.core.modules.system.wrapper.UserAjaxListDictWrapper;
import cn.swallowff.modules.core.modules.system.wrapper.UserDateFormatWrapper;
 ...
 */
@Controller
@RequestMapping(value = "${swear.path.admin}/sys/user")
public class UserController {
    ...
    public String listHtml() {
        return "/pages/admin/system/user/user-list";
    }

    @RequestMapping(value = "add.html")
    public String addHtml() {
        return "/pages/admin/system/user/user-add";
    }
    ...
    public String editHtml(@RequestParam("id") String id, Model model) {
        ...
        return "/pages/admin/system/user/user-edit";
    }
